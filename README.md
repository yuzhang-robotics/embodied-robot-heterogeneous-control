...
| Phase 2 residency-restoration study | P2-D3 target correctness pair complete and valid; P2-D4 commissioning and reconstruction package host-tested, with no commissioning data collected |
